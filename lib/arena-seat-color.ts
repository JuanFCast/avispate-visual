 ...
 * jugador conserva el mismo color del principio al fin sin tener que guardar
 * nada en el cliente ni derivar un hash de su dirección.
 *
 * Es decoración, nunca el único distintivo: en el tablero acompaña al
 * nombre (un punto de color, no reemplaza el texto), y en la tabla de
 * resultado acompaña la misma fila — quien no distingue colores sigue
 * leyendo el nombre.
 */
