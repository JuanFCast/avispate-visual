...
export const en = {
  ...
  "arena.way.create.text":
    "You set the room up and share a 6-character code with your friends.",
  ...
  "join.hint": "6 characters: letters and numbers.",
  "join.cta": "Find room",
  "join.error.not_found": "We couldn't find that room. Check the 6 characters.",
  ...
  "room.error.invalid_code": "That code doesn't look right. They're 6 characters, like MY37GV.",
  ...
  "match.quit": "Hold to leave the match",
  "match.quit.accessible": "Leave the match",
  "match.quit.failed": "Couldn't leave — try again",
  "match.quit.confirm.title": "Leave the match?",
  "match.quit.confirm.text": "You won't be able to come back to this match.",
  "match.quit.confirm.stay": "Keep playing",
  "match.quit.confirm.go": "Yes, leave",
  "match.left.title": "You left",
  "match.left.text": "The match keeps going without you.",
  "match.you_offline":
    "We lost the connection. What you see may be out of date — reconnecting…",
...
export const es: Record<MessageKey, string> = {
  ...
  "arena.way.create.text":
    "Tú defines la sala y compartes un código de 6 caracteres con tus amigos.",
  ...
  "join.hint": "6 caracteres: letras y números.",
  "join.cta": "Buscar sala",
  "join.error.not_found": "No encontramos esa sala. Revisa los 6 caracteres.",
  ...
  "room.error.invalid_code": "Ese código no tiene la forma correcta. Son 6 caracteres, como MY37GV.",
  ...
  "match.quit": "Mantén presionado para abandonar",
  "match.quit.accessible": "Abandonar la partida",
  "match.quit.failed": "No se pudo salir — intenta de nuevo",
  "match.quit.confirm.title": "¿Abandonar la partida?",
  "match.quit.confirm.text": "No podrás volver a esta partida.",
  "match.quit.confirm.stay": "Seguir jugando",
  "match.quit.confirm.go": "Sí, abandonar",
  "match.left.title": "Abandonaste",
  "match.left.text": "La partida sigue sin ti.",
  "match.you_offline":
    "Se perdió la conexión. Lo que ves puede estar desactualizado; reconectando…",
