...
export const en = {
  ...
  /* ---------------------------- Salas privadas --------------------------- */
  "room.tag": "PRIVATE ROOM",
  "room.lead": "Set up a table for your friends, or get in with their code.",
  "room.choice.aria": "Create a room or join one",
  "room.option.create": "Create room",
  ...
  "room.subtitle": "Share the code and wait for everyone to be ready.",
  ...
  "room.guest.hint":
    "The host starts the game once the table is full and everyone is ready.",
  "room.start.cta": "Start game",
  "room.start.need_players": "Waiting for the table to fill up.",
  "room.start.need_ready": "Waiting for everyone to say they're ready.",
  "room.start.ready": "Everyone's in. You can start.",
  "room.start.next_phase":
    "The game will be connected in the next phase. Nobody has been charged and no funds are locked.",
  "room.join_this.cta": "Join this room",
  "room.join_this.login": "Sign in to sit at this table.",
  "room.leave.host": "Close the room",
  "room.leave.guest": "Leave the room",
  "room.back": "← Back to private rooms",
  ...
  "room.error.cta": "Back to private rooms",
...
export const es: Record<MessageKey, string> = {
  ...
  /* ---------------------------- Salas privadas --------------------------- */
  "room.tag": "SALA PRIVADA",
  "room.lead": "Arma una mesa para tus amigos, o entra con el código de ellos.",
  "room.choice.aria": "Crear una sala o entrar a una",
  "room.option.create": "Crear sala",
  "room.option.create.text":
  ...
  /* ----------------------- Dentro de la sala privada --------------------- */
  "room.title": "Tu sala",
  "room.subtitle": "Comparte el código y espera a que todos estén listos.",
  ...
  "room.guest.hint":
    "El anfitrión inicia la partida cuando la mesa esté llena y todos estén listos.",
  "room.start.cta": "Iniciar partida",
  "room.start.need_players": "Falta que se llene la mesa.",
  "room.start.need_ready": "Falta que todos digan que están listos.",
  "room.start.ready": "Están todos. Ya puedes iniciar.",
  "room.start.next_phase":
    "La partida se conectará en la siguiente fase. Nadie ha pagado nada y no hay fondos bloqueados.",
  "room.join_this.cta": "Unirme a esta sala",
  "room.join_this.login": "Inicia sesión para sentarte en esta mesa.",
  "room.leave.host": "Cerrar la sala",
  "room.leave.guest": "Salir de la sala",
  "room.back": "← Volver a salas privadas",
  ...
  "room.error.cta": "Volver a salas privadas",
